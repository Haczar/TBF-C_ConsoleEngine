...
enum EGameSection
{
	ERenderer_GameStart = 0,
	ERenderer_GameSectionSize = 23,
	ERenderer_GameFadeText = 0,
	ERenderer_GameStandardText = 1,
	ERenderer_GameColorText = 2,
	ERenderer_TitleLine = 10,
	ERenderer_VersionLine = 11
