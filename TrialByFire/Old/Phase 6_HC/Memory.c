...
fn returns(Ptr(void)) Internal_Memory_FormatByFill parameters(Ptr(void) _memoryAddress, sint64 _fillValue, DataSize _sizeOfAllocation)
{
	return memset(_memoryAddress, _fillValue, _sizeOfAllocation);
}
