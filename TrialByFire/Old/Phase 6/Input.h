...
alias(EInputState) as Input_KeyState_Array[Keys_NumTracked];

alias(struct StructOf_Input_KeyStates_Def) as StructOf_Input_KeyStates;
...
alias(struct InputState_RingBuffer_Def) InputState_RingBuffer;
